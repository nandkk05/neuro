    ...
    return (
        ...
        <div className="grid w-full items-start gap-6 overflow-auto p-4 pt-0">
            <fieldset className='relative grid gap-6 rounded-lg border p-4'>
                ...
                <Button onClick={extractDetails}>Extract data from file</Button>
                ...
                <Textarea
                    ...
                    placeholder="Extracted content from the pdf document will appear here. Enhance accuracy by providing additional context or related information..."
                ...
                <div className='flex flex-row items-center justify-center gap-2 p-4'>
                    <Label>©Copyright NeurofinAI Technologies Pvt Ltd</Label>
                </div>
            </fieldset>
        </div>
    )
